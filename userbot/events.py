...
import base64
from userbot import bot, BOTLOG_CHATID, LOGSPAMMER, PATTERNS, KEDY_VERSION, ForceVer
...
def register(**args):
    ...
    def decorator(func):
        async def wrapper(check):
            ...
            WolfVer = int(KEDY_VERSION.split(".")[1])
            if ForceVer > WolfVer:
            ...
            try:
                ...
                if not disable_errors:
                    ...
                    link = "[Kedy Destek Grubuna](https://t.me/kedysupport)"
                    if len(eventtext)<10:
